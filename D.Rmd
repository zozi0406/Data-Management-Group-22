...
# SQL code provided for illustration
...
ui <- dashboardPage(
        ...
        dashboardSidebar(
          sidebarMenu(
            menuItem("Ratings over time", tabName = "Tab1", icon = icon("th")),
            menuItem("Sub-scores by ratings", tabName = "Tab2", icon = icon("th")),
            menuItem("Top local authorities by rating", tabName = "Tab3", icon = icon("th"))
          )
        ),
        dashboardBody(
          tabItems(
            tabItem(tabName = "Tab1",
              fluidRow(
                ...
                box(title ="Rating Value slider",
                   sliderInput(inputId = 'RatingValues','Rating Values:',0,5,2)),
                box(title="Business Type select",
                   selectInput(
              ...
              fluidRow(
                ...
                # Local authority rating percentage tab
...
output$Play3 <- renderPlotly(
        {
            ...
            plt4  %>% layout(xaxis = list(categoryorder = "total descending"),title="Local Authorities with highest percentage of given rating value")
        }
    )
